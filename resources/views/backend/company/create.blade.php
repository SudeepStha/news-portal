                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name"  type="text" name="name" placeholder="Company Name" required>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">    
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="district"  type="text" name="district" placeholder="District" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="street"  type="text" name="street" placeholder="Street" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="reg_no"  type="text" name="reg_no" placeholder="Registration Number" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="pan_no">Pan No. <span class="text-danger">*</span></label>
                                    <input class="form-control" id="pan_no"  type="text" name="pan_no" placeholder="Pan Number" required>
                                </div>
                            </div>
                        </div>
                        <hr class="bg-danger">
