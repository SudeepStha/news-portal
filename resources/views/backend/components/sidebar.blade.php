        ...
        <ul id="sidebarnav" class="pt-4">
          ...
          <li class="sidebar-item">
            <a
              ...
              aria-expanded="false"
              ><i class="mdi mdi-view-dashboard"></i
              ><span class="hide-menu">SEO</span></a
            >
          </li>
          <li class="sidebar-item">
            <a
          ...
          <li class="sidebar-item">
            <a
              ...
              aria-expanded="false"
              ><i class="mdi mdi-receipt"></i
              ><span class="hide-menu">Ads Placement </span></a
            >
            <ul aria-expanded="false" class="collapse first-level">
              <li class="sidebar-item">
          ...
          <li class="sidebar-item">
            <a
              ...
              aria-expanded="false"
              ><i class="mdi mdi-view-dashboard"></i
              ><span class="hide-menu">Video Gallery</span></a
            >
          </li>
          <li class="sidebar-item">
            <a
              ...
              aria-expanded="false"
              ><i class="mdi mdi-view-dashboard"></i
              ><span class="hide-menu">Change Theme</span></a
            >
          </li>
